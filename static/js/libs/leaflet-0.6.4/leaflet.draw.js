    ...
    L.drawVersion = "0.2.1-dev", L.drawLocal = {
        ...
        edit: {
            toolbar: {
                ...
                }, buttons: {edit: "Edit layers", remove: "Delete layers"}
            },
            handlers: {
                edit: {
                    tooltip: {
        ...
        options: {
            allowIntersection: !0,
            drawError: {color: "#b00b00", message: L.drawLocal.draw.handlers.polyline.error, timeout: 2500},
        ...
        _getTooltipText: function () {
            var t, e;
            return 0 === this._markers.length ? t = {text: L.drawLocal.draw.handlers.polyline.tooltip.start} : (e = this._getMeasurementString(), t = 1 === this._markers.length ? {
        ...
        addHooks: function () {
            ...
            var e = t.latlng;
            this._tooltip.updatePosition(e), this._isDrawing && (this._tooltip.updateContent({text: L.drawLocal.draw.handlers.simpleshape.tooltip.end}), this._drawShape(e))
        }, _onMouseUp: function () {
        ...
        statics: {TYPE: "marker"}, options: {icon: new L.Icon.Default, zIndexOffset: 2e3}, initialize: function (t, e) {
        ...
        includes: [L.Mixin.Events], initialize: function (t) {
            ...
            for (var e, i, o = L.DomUtil.create("ul", "leaflet-draw-actions"), a = 50, s = t.length, r = s * a + (s - 1), n = 0; s > n; n++) e = L.DomUtil.create("li", "", o), i = this._createButton({
                ...
                context: t[n].context
            }), this._actionButtons.push({button: i, callback: t[n].callback});
        ...
        options: {polyline: {}, polygon: {}, rectangle: {}, circle: {}, marker: {}}, initialize: function (t) {
        ...
        options: {
            ...
            var e = L.DomUtil.create("div", "leaflet-draw-section"), i = 0, o = "leaflet-draw-edit";
            ...
            }), this._toolbarContainer, i++, o, L.drawLocal.edit.toolbar.buttons.edit), this.options.remove && this._initModeHandler(new L.EditToolbar.Delete(t, {featureGroup: this.options.featureGroup}), this._toolbarContainer, i++, o, L.drawLocal.edit.toolbar.buttons.remove), this._lastButtonIndex = --i, this._actionsContainer = this._createActions([
                {
        ...
        statics: {TYPE: "edit"}, includes: L.Mixin.Events, initialize: function (t, e) {
            ...
            this._uneditedLayerProps[e] || (this._uneditedLayerProps[e] = t instanceof L.Polyline || t instanceof L.Polygon || t instanceof L.Rectangle ? {latlngs: L.LatLngUtil.cloneLatLngs(t.getLatLngs())} : t instanceof L.Circle ? {
        ...
        statics: {TYPE: "remove"}, includes: L.Mixin.Events, initialize: function (t, e) {
            ...
            this._map && (this._deletableLayers.eachLayer(this._enableLayerDelete, this), this._deletedLayers = new L.layerGroup, this._tooltip = new L.Tooltip(this._map), this._tooltip.updateContent({text: L.drawLocal.edit.handlers.remove.tooltip.text}), this._map.on("mousemove", this._onMouseMove, this))
        }, removeHooks: function () {
