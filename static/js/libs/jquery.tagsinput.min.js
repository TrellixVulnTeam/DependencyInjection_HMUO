(function (a) {
    ...
    a.fn.addTag = function (d, e) {
        ...
        this.each(function () {
            ...
            if (d != "" && h != true) {
				 var wordvec;
				 //split string with comma into substrings wordvec
				 if(d.indexOf(",") !== -1){
					wordvec = d.split(",");
				 }
				else{
				...
				//for each word in word vec, make it a tag
				for(var qIndex = 0; qIndex < wordvec.length; qIndex++){
					var word = wordvec[qIndex];
					d = word;
    ...
    a.fn.tagsInput = function (d) {
        var e = jQuery.extend({interactive: true, defaultText: "add a tag", minChars: 0, width: "100%", height: "100px", autocomplete: {selectFirst: false}, hide: true, delimiter: ",", unique: true, removeWithBackspace: true, placeholderColor: "#666666", autosize: true, comfortZone: 20, inputPadding: 6 * 2}, d);
        this.each(function () {
            if (e.hide) {
                a(this).hide()
            }
